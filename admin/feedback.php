...
<body>
  ...
  <main>
    <div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark" style="width: 280px;">
      <a href="admin.php" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none">
        <svg class="bi bi-plus" width="40" height="40"><use xlink:href="#logo"/></svg>
          <span class="fs-4">Pemerintah</span>
        </a>
        <hr>
      ...
      <div class="col">
        ...
        <table class="table">
          ...
          <tbody>
            ...
            include '../koneksi.php';
            $no = 1;
            $data = mysqli_query($koneksi,"select * from feedback");
  ...
  <script src="../asset/js/asidebars.js"></script>
</body>
</html>
